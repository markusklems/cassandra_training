...
do
  ...
  iptables -I OUTPUT -p tcp -m tcp -s $ip --dport 7000 -j ACCEPT
  iptables -I OUTPUT -p tcp -m tcp -s $ip --dport 7001 -j ACCEPT
done
iptables -I INPUT -p tcp -m tcp -s 0.0.0.0/0 --dport 7000 -j DROP
iptables -I INPUT -p tcp -m tcp -s 0.0.0.0/0 --dport 7001 -j DROP
iptables -I OUTPUT -p tcp -m tcp -s 0.0.0.0/0 --dport 7000 -j DROP
iptables -I OUTPUT -p tcp -m tcp -s 0.0.0.0/0 --dport 7001 -j DROP